...
This guide will walk you through creating a blog application.
...
:::tip
[rhino_owner_global](core/resources/#global-owner) indicates there is no owner for this model. It is a global resource.
:::
...
:::tip
[rhino_owner_base](core/resources/#base-owner) assigns the owner of this model to "base owner", which is the User by default in Rhino
:::

:::tip
[rhino_references](core/resources/#references) includes the related models in the API response
:::
...
:::tip
[rhino_owner](core/resources/#ownership) ownership of this model to another model, in this case the `Blog` model, which is the User by default in Rhino
:::
