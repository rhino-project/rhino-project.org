...
The tests are located in the `client/src/__tests__` directory.
...
Rhino uses Cypress for E2E testing. The tests are located in the `client/cypress/integration` directory. Cypress can be loaded with the following command:
