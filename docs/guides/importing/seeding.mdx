...
Seeding data is a way to populate your database with data. This is useful in all environments, but especially in development and test environments. Rhino seeding is based on the [Rails seeding system](https://guides.rubyonrails.org/v5.1/active_record_migrations.html#migrations-and-seed-data)
