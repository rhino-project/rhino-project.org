...
#### Fetch the `v3.0.0-beta.27` tag from Rhino and name it `rhino-project-template-v3.0.0-beta.27` locally:

```
git fetch rhino-project-template v3.0.0-beta.27:rhino-project-template-v3.0.0-beta.27
```

#### Get the latest updates from Rhino's repository

```
git checkout rhino-project-template-v3.0.0-beta.27
```
...
#### Merge the updated `rhino-project-template-v3.0.0-beta.27` into the newly created branch:

:::danger
Remove `client/node_modules` before merging otherwise you may encounter https://github.com/npm/cli/issues/4828
:::

```
git merge rhino-project-template-v3.0.0-beta.27
```
...
Date:   Mon Jan 10 20:29:39 2022 -0300
    ...
    Merge branch 'rhino-project-template-v3.0.0-beta.27' into task/PROJ-777
```
