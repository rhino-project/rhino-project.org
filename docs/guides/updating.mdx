...
#### Fetch the `v3.0.0-beta.28` tag from Rhino and name it `rhino-project-template-v3.0.0-beta.28` locally:

```
git fetch rhino-project-template v3.0.0-beta.28:rhino-project-template-v3.0.0-beta.28
```

#### Get the latest updates from Rhino's repository

```
git checkout rhino-project-template-v3.0.0-beta.28
```
...
#### Merge the updated `rhino-project-template-v3.0.0-beta.28` into the newly created branch:
...
```
git merge rhino-project-template-v3.0.0-beta.28
```
...
Date:   Mon Jan 10 20:29:39 2022 -0300
    ...
    Merge branch 'rhino-project-template-v3.0.0-beta.28' into task/PROJ-777
```
