...
#### Fetch the `v3.0.0-beta.19` tag from Rhino and name it `boilerplate-v3.0.0-beta.19` locally:

```
git fetch boilerplate v3.0.0-beta.19:boilerplate-v3.0.0-beta.19
```

#### Get the latest updates from Rhino's repository

```
git checkout boilerplate-v3.0.0-beta.19
```
...
#### Merge the updated `boilerplate-v3.0.0-beta.19` into the newly created branch:

```
git merge boilerplate-v3.0.0-beta.19
```
...
Date:   Mon Jan 10 20:29:39 2022 -0300
    ...
    Merge branch 'boilerplate-v3.0.0-beta.19' into task/NUB-777
```
