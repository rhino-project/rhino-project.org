...
#### Fetch the `v3.0.0-beta.22` tag from Rhino and name it `boilerplate-v3.0.0-beta.22` locally:

```
git fetch boilerplate v3.0.0-beta.22:boilerplate-v3.0.0-beta.22
```

#### Get the latest updates from Rhino's repository

```
git checkout boilerplate-v3.0.0-beta.22
```
...
#### Merge the updated `boilerplate-v3.0.0-beta.22` into the newly created branch:

```
git merge boilerplate-v3.0.0-beta.22
```
...
Date:   Mon Jan 10 20:29:39 2022 -0300
    ...
    Merge branch 'boilerplate-v3.0.0-beta.22' into task/NUB-777
```
