...
#### Fetch the `v3.0.0-beta.15` tag from Rhino and name it `boilerplate-v3.0.0-beta.15` locally:

```
git fetch boilerplate v3.0.0-beta.15:boilerplate-v3.0.0-beta.15
```

#### Get the latest updates from Rhino's repository

```
git checkout boilerplate-v3.0.0-beta.15
```
...
#### Merge the updated `boilerplate-v3.0.0-beta.15` into the newly created branch:

```
git merge boilerplate-v3.0.0-beta.15
```
...
Date:   Mon Jan 10 20:29:39 2022 -0300
    ...
    Merge branch 'boilerplate-v3.0.0-beta.15' into task/NUB-777
```
