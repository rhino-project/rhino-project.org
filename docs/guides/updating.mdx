...
#### Fetch the `v2.1.0` tag from Rhino and name it `boilerplate-v2.1.0` locally:

```
git fetch boilerplate v2.1.0:boilerplate-v2.1.0
```

#### Get the latest updates from Rhino's repository

```
git checkout boilerplate-v2.1.0
```
...
#### Merge the updated `boilerplate-v2.1.0` into the newly created branch:

```
git merge boilerplate-v2.1.0
```
