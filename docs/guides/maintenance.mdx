...
The core rhino repo `nubinary/boilerplate_mono` is configured to use Dependabot for security to automatically flag issues. Dependabot will open a PR when a dependency has a new version available.
