...
This guide will walk you through extending the [Tutorial](tutorial) to add more advanced features:
...
Ensure you have completed the [Tutorial](tutorial).
...
:::warning
You must include the `:banner_attachment` in the [rhino_references](core/resources/#references) array to make the file available through the Blog API call.
:::
