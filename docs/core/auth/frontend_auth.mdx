...
![](/img/auth-overall-process.drawio.svg)
...
![](/img/auth-start-signin-unauthenticated.drawio.svg)
...
![](/img/auth-start-signin-authenticated.drawio.svg)
...
![](/img/auth-start-root-unauthenticated.drawio.svg)
...
![](/img/auth-start-root-authenticated.drawio.svg)
...
![](/img/auth-signin-process.drawio.svg)
...
![](/img/auth-signout-process.drawio.svg)
