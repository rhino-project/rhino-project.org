...
Rhino provides a way to [seed the database per environment](../guides/importing/seeding) with data. This is useful for testing and development. Create a few categories to use in the blog to go with the admin user and user that has already been created.
